...
--
-- Host: localhost    Database: dbback
-- ------------------------------------------------------
...
INSERT INTO `testimoniales` VALUES (1,'Naira','naira@gmail.com','Que buenas vacaciones!'),(2,'Cora','cora@mail.com','Recomendado 100%'),(3,'Sr P','p@p.com','Muy buen trato con nosotros y excelente gestion en el viaje. Volveremos a viajar sin duda.'),(4,'Canela','canela@mail.com','Excelente agencia'),(5,'Pablo','pablo@mail.com','Amable atención'),(6,'Nai','naira@gmail.com','Neque porro quisquam est qui dolorem ipsum quia dolor sit amet');
...
CREATE TABLE `viajes` (
  ...
  `lugares_disponibles` varchar(3) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-24 16:18:05
